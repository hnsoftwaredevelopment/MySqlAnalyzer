...
{
    public class StoredProcedureRepository : BaseRepository
    {
        public StoredProcedureRepository(string connectionString) : base(connectionString) { }
        
        public List<StoredProcedureModel> GetStoredProcedures(string databaseName)
        {
            ...
            {
                var procedure = new StoredProcedureModel
                {
        ...
        public List<ParameterModel> GetProcedureParameters(string databaseName, string procedureName)
        {
